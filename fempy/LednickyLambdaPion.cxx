...
//    double sourcePar3 = par[6];  // normalization of the gaussians
//    complex<double> ScatLen(potPar0, potPar1);
//    return sourcePar3 * (sourcePar2 * GeneralLednicky(kStar, sourcePar0, ScatLen, potPar2, 0, 0, true, false, false) 
//           + (1 - sourcePar2) * GeneralLednicky(kStar, sourcePar1, ScatLen, potPar2, 0, 0, true, false, false)) + 1. - sourcePar3;
//}
...
//     return SourcePar[3] * (SourcePar[2] * GeneralLednicky(Momentum, SourcePar[0], ScatLen, PotPar[2], 0, 0, true, false, false) 
//            + (1 - SourcePar[2]) * GeneralLednicky(Momentum, SourcePar[1], ScatLen, PotPar[2], 0, 0, true, false, false)) + 1. - SourcePar[3];
// }ComplexLednicky_Singlet_doublegaussian_lambda