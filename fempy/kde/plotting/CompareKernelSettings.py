...
if __name__ == '__main__':
    ...
    kernelVariationList = [f'Densities_kern-{k}_iter-Adaptive_mirror-NoMirror_binning-RelaxedBinning.root' for k in kernelIds]
    CompareKernelSettings(kernelVariationList)