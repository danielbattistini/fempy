...
void MakeOvalTiltedEvent() {
    ...
    for (int iPart=0; iPart<nPart; iPart++)
        (*particles)[iPart] = new TParticle(211, 1, 0, 0, 0, 0, 3*cos(6.28*double(iPart)/nPart), sin(6.28* double(iPart)/nPart), gRandom->Gaus()*0.05, 0, 0, 0, 0, 0);
    ...
    for (int iPart=0; iPart<nPart; iPart++) {
        (*particlesAfter)[iPart] = new TParticle(211, 1, 0, 0, 0, 0, parts[iPart].Px(), parts[iPart].Py(), parts[iPart].Pz(), 0, 0, 0, 0, 0);
